...
class CDnet(object):
    ...
    def model(self, input_1, batch_slice=1):
        ...
        #========= STAGE 2 =============
        input_2 = tf.concat([input_1[:, :, :, :3], tf.expand_dims(rendering_result_1, axis=-1)], axis=-1)
        ...
        #========= STAGE 3 =============
        input_3 = tf.concat([input_1[:, :, :, :3], tf.expand_dims(rendering_result_2, axis=-1)], axis=-1)
        ...
        #========= STAGE 2 =============
        input_4 = tf.concat([input_1[:, :, :, :3], tf.expand_dims(rendering_result_3, axis=-1)], axis=-1)
